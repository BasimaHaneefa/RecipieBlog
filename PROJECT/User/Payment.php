...
{
	$ins="update tbl_order set payment_status=1 where order_id=".$_GET['bid'];
	$Conn->query($ins);
	?>
    <script>
	alert("Payment Successful")
	window.location="ViewMyOrder.php";
	</script>
    <?php
}
...
<body>
	...
	<div class="wrapper">
		...
		<form method="POST">
            ...
            <div class="input-group">
				<div class="input-box">
					<input class="name" type="tel" id="txtrate" name="txtrate"  value="Rs.<?php echo $_GET["amnt"] ?>" readonly>
